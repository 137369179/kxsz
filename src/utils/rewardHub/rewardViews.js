...
/**  */
export function _renderStickerWall(panel) {
...
/** 荣誉勋章墙 */
export function _renderMedalWall(panel) {
  const __lockIcon = GAME_ICONS.shieldLock();
...
/**  /  */
export function _renderShop(panel) {
      const __sparkleIcon = GAME_ICONS.star();
...
export function _bindShopActions() {
...
/**  */
export function _renderCalendar(panel) {
      const __sparkleIcon = GAME_ICONS.star();
  const __trophyIcon = GAME_ICONS.trophy();
...
// 
// ------------------------------------------------------------
export function _bindTabEvents() {
...
export function _bindCalendarNav() {
...
/** "" */
export function _celebrateNewMedals() {
  const __trophyIcon = GAME_ICONS.trophy();
